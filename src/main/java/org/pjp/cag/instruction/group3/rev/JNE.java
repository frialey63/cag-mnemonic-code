...
/**
 * If the accumulator is non-zero then jump to the address which may be modified.
 * @author developer
 *
 */
public final class JNE extends Instruction {
     ...
     */
    public JNE(boolean query, int address, int modifier) {
