...
/**
 * If the accumulator is greater than or equal to zero then jump to the address which may be modified.
 * @author developer
 *
 */
public final class JGE extends Instruction {
     ...
     */
    public JGE(boolean query, int address, int modifier) {
