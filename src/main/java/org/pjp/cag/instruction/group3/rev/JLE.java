...
/**
 * If the accumulator is lesser than or equal to zero then jump to the address which may be modified.
 * @author developer
 *
 */
public final class JLE extends Instruction {
     ...
     */
    public JLE(boolean query, int address, int modifier) {
